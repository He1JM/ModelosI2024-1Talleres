"""
This is the program in which I try to solve the Workshop #2 problem

Author: Henry Jhonmarcos Osorio Sánchez <hjosorios@udistrital.edu.co>
...
# ==================================== MENU
MESSAGE = """
Option 1. Search by price range (NEW)
Option 2. Create car
...
# Abstract Factory
class EngineFactory:
    def create_gasengine(self):
        pass

    def create_elecengine(self):
        pass


# Concrete Factory
class GasEngineFactory(EngineFactory):
    def create_lowgamma(self):
        return LowGasEngine()

    def create_highgamma(self):
        return HighGasEngine()


# Concrete Factory
class ElectricEngineFactory(EngineFactory):
    def create_lowgamma(self):
        return LowElectricEngine()

    def create_highgamma(self):
        return HighElectricEngine()
...
# Concrete Product
class LowGasEngine(GasEngine):
    def create(self):
        print("Creating a Low Gamma Gas Engine")


# Concrete Product
class HighGasEngine(GasEngine):
    def create(self):
        print("Creating a High Gamma Gas Engine")
...
# Concrete Product
class LowElectricEngine(ElectricEngine):
    def create(self):
        print("Creating a Low Gamma Electric Engine")


# Concrete Product
class HighElectricEngine(ElectricEngine):
    def create(self):
        print("Creating a High Gamma Electric Engine")
...
""""
gasengine_factory = GasEngineFactory()
electricengine_factory = ElectricEngineFactory()
...
def search_by_price(price_: int) -> list:
  return [vehicle for vehicle in vehicles if vehicle.get_year() == price_]
...
while option != 10:
    if option == 1:
        price = float(input("Please, write the price range:"))
